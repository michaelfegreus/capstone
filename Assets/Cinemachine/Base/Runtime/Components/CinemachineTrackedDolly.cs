...
namespace Cinemachine
{
	...
	public class CinemachineTrackedDolly : MonoBehaviour, ICinemachineComponent
	{
		...
		// MIKE: Mod to add pathPositionOffset value
		[Tooltip("Mike here. This is a modification to add a path position offset so the dolly isn't always right up in your character's grill. Be wary of this breaking in a Cinemachine update.")]
		public float pathPositionOffset;
			...
			CameraState curState, CameraState statePrevFrame, float deltaTime)
		{
			...
			Vector3 newCameraPos = m_Path.EvaluatePosition(newPathPosition + pathPositionOffset); // MIKE: Mod to add pathPositionOffset value
